...
import org.apache.rocketmq.remoting.protocol.RequestCodeToName;
...
public abstract class NettyRemotingAbstract {
    ...
    public void processRequestCommand(final ChannelHandlerContext ctx, final RemotingCommand cmd) {
        ...
        /* CODE_MARK [remoting] 收到 Request */
        log.info("receive {} command from {} ",
                RequestCodeToName.getCommandName(cmd.getCode()),
